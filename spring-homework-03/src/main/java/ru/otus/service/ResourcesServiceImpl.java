...
public class ResourcesServiceImpl implements SourceService {
    ...
    public ResourcesServiceImpl(AppProps appProps) {
    ...
    public List<Questionnaire> getQuestions() {
        ...
        InputStream is = Application.class.getClassLoader().getResourceAsStream(appProps.getResourcePath() + "_" + appProps.getLocale().getLanguage() + EXT);
